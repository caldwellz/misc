...
___testPrime:
	...
	push	edx	; Set up a temp-space on the stack for later.
	...
	fild	dword [ebp+20]	; Put the argument into the FPU.
	fsqrt			; Square-root it.
	fistp	dword [ebp+16]	; Save the result in our temp-space.
	...
	.end:
		pop	edx 	; Free temp space, restore clobbered registers, and return.
		pop 	edx
		pop 	ecx
		pop 	ebp
		ret
